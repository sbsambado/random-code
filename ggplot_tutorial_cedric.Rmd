...
making fancier titles and supporting plot text
```{r}
ggplot(chic, aes(x = date, y = temp)) +
  geom_point(color = "firebrick") +
  labs(x = "Year", y = NULL) +
...
grouping data by variable level
```{r}
chic$season <- 
  factor(chic$season, 
